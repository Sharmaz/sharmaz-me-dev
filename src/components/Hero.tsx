...
const Hero = ({ name, resumeLink }: HeroProps) => {
  ...
  return (
    <section ref={ref} className="text-2xl text-slate-300 mx-4 mb-10 mt-36 md:text-5xl max-w-screen-lg md:pl-8 md:mx-auto relative">
      <span className="block relative p-[3px_2px] hero-style before:content-['Hi,'] before:orange-gradient before:animation-delay-0">Hi,</span>
      <span className="block relative p-[3px_2px] hero-style before:content-['I’m_Ivan_Robles,'] before:red-gradient before:animation-delay-3">{`I’m ${name},`}</span>
      <span className="block relative p-[3px_2px] hero-style before:content-['a_Frontend_Developer'] before:purple-gradient before:animation-delay-6">a Frontend Developer</span>
